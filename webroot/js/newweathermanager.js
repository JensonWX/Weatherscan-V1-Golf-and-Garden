function Intro() {
  ...
  function grabCity8SlidesData() {
    weatherInfo.currentCond.city8slides.cities = [];
  ...
  function grabCitySlidesData() {
    ...
    $.getJSON(url, function(data) {
      data.forEach((ajaxedLoc, i) => {
        ...
        console.log(weatherInfo.currentCond.weatherLocs.length);
      });
    }).fail(function() {
  ...
  function grabGardenData() {
    $.getJSON("https://api.weather.com/v2/indices/wateringNeeds/daypart/3day?geocode=" + maincitycoords.lat + "," + maincitycoords.lon + "&format=json&language=en-US&apiKey=" + api_key,
      function (data) {
