...
var apperanceSettings = {
  ...
  affilateName:"Xfinity TV",// Ex. "Comcast"
  logoURL:"images/tvproviders/Xfinity.png", //image size must be 879*184px or similar aspect ratio.
  ...
  startupTime: 19000, //How long you want to wait for everything to load
}
...
var slideLoopSettings = {
  ...
  {type:"cities",
    ...
    slideDelay:10000,
    slideOrder:[
      {name:"cityIntro",slideDelay:""},
      {name:"upNext",slideDelay:""},
      {name:"bulletin",slideDelay:"",testDisplay:'if (weatherInfo.bulletin.weatherLocs[replaceLocIdx].enabled != true) {return true}'},
      {name:"currentConditions",slideDelay:""},
      {name:"city8Slides",slideDelay:""},
      {name:"localDoppler",slideDelay:""},
      {name:"dayDesc",slideDelay:""},
      {name:"extendedForecast",slideDelay:""},
      {name:"almanac",slideDelay:"",testDisplay:'if (weatherInfo.bulletin.weatherLocs[replaceLocIdx].enabled == true) {return true}'}
    ]
  },
  {type:"traffic",
    repeat:true,
    ...
    slideDelay:10000,
    slideOrder:[
      {name:"trafficIntro",slideDelay:""},
      {name:"trafficOverview",slideDelay:""},
      {name:"trafficReport",slideDelay:"",testDisplay:'if (weatherInfo.trafficIncidents.enabled != true) {return true}'}
    ]
  },
  {type:"cities",
    repeat:true,locidx:'extra',slideDelay:10000,slideOrders:[
      [
        {name:"upNext",slideDelay:""},
        {name:"bulletin",slideDelay:"",testDisplay:'if (weatherInfo.bulletin.weatherLocs[replaceLocIdx].enabled != true) {return true}'},
        {name:"currentConditions",slideDelay:""},
        {name:"localDoppler",slideDelay:"",testDisplay:'return (Math.random() > 0.75) ? true : false',alternate:{name:"regionalSatellite",slideDelay:""}},
        {name:"dayPart",slideDelay:""},
        {name:"extendedForecast",slideDelay:""}
      ],
      [
        {name:"upNext",slideDelay:""},
  ...
  {type:"health",
    repeat:true,
    locidx:0,
    slideDelay:7833.333333,
    slideOrder:[
      {name:"healthIntro",slideDelay:""},
      {name:"healthForecast",slideDelay:""},
      {name:"pollen",slideDelay:"",testDisplay:"if (!weatherInfo.healthPollen.totalcat || weatherInfo.healthforecast.noReport != false) {return true}"},
      {name:"achesBreath",slideDelay:""},
      {name:"airQuality",slideDelay:""},
      {name:"uvIndex",slideDelay:""},
      {name:"healthTip",slideDelay:""},
      {name:"moreInfoImage",slideDelay:""}
    ]
  },
  {type:"golf",
    repeat:true,
    locidx:0,
    slideDelay:8666.666667,
    slideOrder:[
      {name:"golfIntro",slideDelay:""},
      {name:"teeTime",slideDelay:""},
      {name:"golfIndexForecast",slideDelay:""},
      {name:"courseForecast",slideDelay:""},
      {name:"golfPromo",slideDelay:""}
    ]
  },
  {type:"garden",
    repeat:true,
    ...
    slideDelay:10000,
    slideOrder:[
      {name:"gardenIntro",slideDelay:""},
      {name:"gardeningForecast",slideDelay:""},
      {name:"estimatedPrecip",slideDelay:""},
      {name:"precipForecast",slideDelay:""},
      {name:"droughtMonitor",slideDelay:""},  
      {name:"moreGardenImage",slideDelay:""}
    ]
  },
  {type:"cities",
    repeat:true,
  ...
  {type:"airport",
    ...
    slideDelay:10000,
    slideOrder:[
      {name:"airportIntro",slideDelay:""},
      {name:"airportConditions",slideDelay:""},
      {name:"otherAirportConds",slideDelay:""}
    ]
  },
  {type:"travel",
    repeat:true,
    ...
    slideDelay:10000,
    slideOrder:[
      {name:"travelIntro",slideDelay:""},
      {name:"travelWeather",slideDelay:""},
      {name:"regionalTravel",slideDelay:""},
      {name:"destinationForecast",slideDelay:""}
    ]
  },
  {type:"international",
    repeat:true,
    ...
    slideDelay:10000,
    slideOrder:[
      {name:"internationalIntro",slideDelay:""},
      {name:"internationalForecast",slideDelay:""}
    ]
  },
  {type:"cities",
    loopComplete:true,
...
var severeLoopSettings = {radarTransition:true,order:[
  {
    ...
    slideDelay:10000,
    slideOrder:[
      {name:"severeMessage",slideDelay:""},
      {name:"bulletin",slideDelay:"",testDisplay:'if (weatherInfo.bulletin.weatherLocs[replaceLocIdx].enabled != true) {return true}'},
      {name:"severeCurrentConditions",slideDelay:""},
      {name:"severeCity8Slides",slideDelay:""},
      {name:"severeLocalDoppler",slideDelay:""},
      {name:"severeDayDesc",slideDelay:""},
      {name:"severeExtendedForecast",slideDelay:""},
      {name:"severeAlmanac",slideDelay:""}
    ]
  },
  {
    type:"severe-cities",
    ...
    slideOrder:[
      {name:"severeMessage",slideDelay:""},
      {name:"severeCurrentConditions",slideDelay:""},
      {name:"severeLocalDoppler",slideDelay:"",testDisplay:'return (Math.random() > 0.5) ? true : false',alternate:{name:"severeRegionalSatellite",slideDelay:""}},
      {name:"severeDayPart",slideDelay:""},
      {name:"severeExtendedForecast",slideDelay:""}
    ]
  },
  {
